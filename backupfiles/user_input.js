...
export const user_input = {
    ...
    check_border: () => {
        ...
        console.log(piece.current_positions);
        piece.current_positions.forEach((position) => {     
            if(position.x - 31 < 0 || position.y + 31 >= 682 || position.x >= 310) {
                console.log('match');
    ...
    can_current_piece_spin: () => {
        ...
        //* le check
        let can_spin = true;
        let touch_border = user_input.check_border();
                        ...
                        case 'default':  
                            ...
                            grid.all_positions.forEach((grid_position) => {
                                if (piece.current_positions[0].x + 31 === grid_position.x 
                                    ...
                                    /* ||
                                    || */ ) {
                                        //console.log(`position[0] --> x: ${piece.current_positions[0].x + 31}, y: ${piece.current_positions[0].y - 31}`);
                                        //* on ne fait pas de rotation, on remet la valeur de l'index par défaut
                                        can_spin = false;
                                    } else if( piece.current_positions[2].x - 31 === grid_position.x 
                                        && piece.current_positions[2].y + 31 === grid_position.y 
                                        && grid_position.used === 1) {
                                            //console.log(`position[2] --> x: ${piece.current_positions[2].x - 31}, y: ${piece.current_positions[2].y + 31}`);
                                            can_spin = false;
                                    } else if(piece.current_positions[3].x + 62 === grid_position.x 
                                        && piece.current_positions[3].y + 62 === grid_position.y 
                                        && grid_position.used === 1) {
                                            //console.log(`position[3] --> x: ${piece.current_positions[3].x - 62}, y: ${piece.current_positions[3].y + 62}`);
                                            can_spin = false;
                                    } else {
